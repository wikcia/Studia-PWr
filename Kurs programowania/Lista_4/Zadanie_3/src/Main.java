...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Enum[] FirstArgumentMain = new Enum[args[0].length()];
        int counter = 1;
        double parameter;
            ...
            switch (result) {
                case 'o':
                    try {
                        ...
                        if(parameter > 0) {
                            // nie inicjalizujemy obiektow typu wyliczeniowego
                            Enum circle = Figure.OneParameterFigure.CIRCLE;
                    ...
                    try {
                        ...
                        if (kat > 0 && kat < 180) {
                            ...
                            if ((edges[0] == edges[1]) && (edges[1] == edges[2]) && (edges[2] == edges[3])) {
                                if (kat == 90) {
                                    Enum square = Figure.OneParameterFigure.SQUARE;
        ...
        for (Enum objects : FirstArgumentMain) {
            if (objects != null) {
                System.out.println("Area: " + objects.area());
                System.out.println("Circuit: " + objects.circuit());
            }
        }
    }
}